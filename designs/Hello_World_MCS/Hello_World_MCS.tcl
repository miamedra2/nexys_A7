...
#
# Hello_World_MCS.tcl: Tcl script for re-creating project 'Hello_World_MCS'
#
# Generated by Vivado on Sun Jan 31 11:32:57 -0800 2021
...
#
# 1. This project restoration tcl script (Hello_World_MCS.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/github/nexus_ddr4/Hello_World_MCS/src/cpu/hdl/cpu_wrapper.v"
#    "C:/github/nexus_ddr4/Hello_World_MCS/Hello_World_MCS.sdk/Hello_World/Debug/Hello_World.elf"
#
...
set _xil_proj_name_ "Hello_World_MCS"
...
set script_file "Hello_World_MCS.tcl"
...
set files [list \
 [file normalize "${origin_dir}/src/cpu/hdl/cpu_wrapper.v" ]\
 [file normalize "${origin_dir}/Hello_World_MCS.sdk/Hello_World/Debug/Hello_World.elf" ]\
]
...
set_property -name "top" -value "cpu_wrapper" -objects $obj
...
proc cr_bd_cpu { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.GPI1_SIZE {16} \
   CONFIG.GPI3_SIZE {5} \
   CONFIG.GPIO1_BOARD_INTERFACE {dip_switches_16bits} \
   CONFIG.GPIO2_BOARD_INTERFACE {led_16bits} \
   CONFIG.GPIO3_BOARD_INTERFACE {push_buttons_5bits} \
   CONFIG.GPO2_SIZE {16} \
  ...
  connect_bd_intf_net -intf_net microblaze_mcs_0_GPIO1 [get_bd_intf_ports dip_switches_16bits] [get_bd_intf_pins microblaze_mcs_0/GPIO1]
  connect_bd_intf_net -intf_net microblaze_mcs_0_GPIO2 [get_bd_intf_ports led_16bits] [get_bd_intf_pins microblaze_mcs_0/GPIO2]
  connect_bd_intf_net -intf_net microblaze_mcs_0_GPIO3 [get_bd_intf_ports push_buttons_5bits] [get_bd_intf_pins microblaze_mcs_0/GPIO3]
...
#  -string -flagsOSRD
preplace port led_16bits -pg 1 -y 120 -defaultsOSRD
preplace port dip_switches_16bits -pg 1 -y 90 -defaultsOSRD
preplace port sys_clock -pg 1 -y 80 -defaultsOSRD
preplace port push_buttons_5bits -pg 1 -y 150 -defaultsOSRD
preplace port usb_uart -pg 1 -y 60 -defaultsOSRD
preplace port reset -pg 1 -y 110 -defaultsOSRD
preplace inst microblaze_mcs_0 -pg 1 -lvl 1 -y 100 -defaultsOSRD
preplace netloc microblaze_mcs_0_UART 1 1 1 420J
preplace netloc microblaze_mcs_0_GPIO1 1 1 1 420J
preplace netloc microblaze_mcs_0_GPIO2 1 1 1 NJ
preplace netloc sys_clock_1 1 0 1 20J
preplace netloc microblaze_mcs_0_GPIO3 1 1 1 420J
preplace netloc reset_1 1 0 1 NJ
levelinfo -pg 1 0 220 440 -top 0 -bot 200
"
}
